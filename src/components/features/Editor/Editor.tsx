...
export const Editor = memo(function Editor() {
  ...
  const setBeforeContent = useStore((s) => s.setBeforeContent);
  const setAfterContent = useStore((s) => s.setAfterContent);
  const setBeforeLabel = useStore((s) => s.setBeforeLabel);
  const setAfterLabel = useStore((s) => s.setAfterLabel);
  const setBeforeLanguage = useStore((s) => s.setBeforeLanguage);
  const setAfterLanguage = useStore((s) => s.setAfterLanguage);
